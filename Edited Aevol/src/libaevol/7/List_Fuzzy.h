...
#ifndef AEVOL_LIST_FUZZY_H
#define AEVOL_LIST_FUZZY_H
...
class List_Fuzzy : public AbstractFuzzy_7
{
 public:
  // ==========================================================================
  //                               Constructors
  // ==========================================================================
  List_Fuzzy() : points_({Point(X_MIN, 0.0), Point(X_MAX, 0.0)}) {};
  List_Fuzzy(const List_Fuzzy& f): points_(f.points_) {};

    List_Fuzzy(const Fuzzy& f){
        for (auto p : f.points())
            points_.push_back(p);
    };

  List_Fuzzy(const gzFile backup) { load(backup); };
